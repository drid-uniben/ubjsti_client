  ...
  const fetchData = async () => {
    try {
      ...
      const [assignmentsData, statsData] = await Promise.all([
        manuscriptReviewerApi.getReviewerAssignments(),
        manuscriptReviewerApi.getReviewerStatistics(),
      ]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 p-4 md:p-6">
        ...
        <div className="max-w-7xl mx-auto mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Review Assignments</h1>
                    ...
                    <div className="p-4 md:p-6">
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col gap-2 lg:ml-6">
                          <Link
                            href={`/reviewer/assignments/${assignment._id}`}
