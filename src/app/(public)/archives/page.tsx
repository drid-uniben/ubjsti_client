...
export default function ArchivesPage() {
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="flex justify-center items-center py-20">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-[#071936] font-medium">Loading archives...</p>
          </div>
        </div>
        <Footer />
      </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#071936] via-[#0e3169] to-[#071936] text-white py-20 overflow-hidden">
        {/* Decorative Elements */}
              ...
              {years.map((year) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between p-8 hover:bg-gradient-to-r hover:from-[#071936]/5 hover:to-transparent transition-all duration-300 group"
                  >
                    <div className="flex items-center gap-6">
                      <div className="relative">
                        <div className="w-16 h-16 bg-gradient-to-br from-[#071936] to-[#071936] rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="absolute -top-2 -right-2 w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center">
                          <TrendingUp className="h-3 w-3 text-[#071936]" />
                        </div>
                      </div>
                      <div className="text-left">
                        <h2 className="text-3xl font-bold text-[#071936] font-serif group-hover:text-[#0e3169] transition-colors">
                          {year}
                        </h2>
                    ...
                    <div className="flex items-center gap-4">
                      {expandedYear === year ? (
                        <ChevronUp className="h-8 w-8 text-[#071936] group-hover:scale-110 transition-transform" />
                      ) : (
                        <ChevronDown className="h-8 w-8 text-[#071936] group-hover:scale-110 transition-transform" />
                      )}
                    </div>
                  </button>
                        ...
                        {volumesByYear[year].map((volume) =>
                          volume.issues.map((issue) => (
                            <Link
                              key={issue._id}
                              href={`/current-issue`}
                              className="group bg-white border-2 border-[#EAD3D9] rounded-2xl overflow-hidden hover:shadow-2xl hover:border-[#071936] transition-all duration-300 hover:-translate-y-1"
                            >
                              <div className="flex flex-col sm:flex-row gap-6 p-6">
                                ...
                                <div className="flex-1">
                                  <div className="flex flex-wrap items-center gap-3 mb-4">
                                    <span className="inline-flex items-center px-4 py-1.5 bg-[#071936] text-white rounded-full text-xs font-bold uppercase tracking-wide shadow-md">
                                  ...
                                  <h3 className="text-2xl font-bold text-[#071936] mb-3 group-hover:text-[#0e3169] transition-colors font-serif">
                                    {volume.description ||
                                  ...
                                  <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600 mb-4">
                                    <div className="flex items-center gap-2">
                                      <Calendar className="h-4 w-4 text-[#071936]" />
                                    ...
                                    <div className="flex items-center gap-2">
                                      <FileText className="h-4 w-4 text-[#071936]" />
                                      <span className="font-medium">
                                  ...
                                  <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                                    <span className="inline-flex items-center gap-2 bg-[#071936] text-white px-6 py-2.5 rounded-xl font-semibold text-sm shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all">
                                      <BookOpen className="h-4 w-4" />
                                      View Issue
                                    </span>
                                    <span className="inline-flex items-center gap-2 border-2 border-[#071936] text-[#071936] px-6 py-2.5 rounded-xl font-semibold text-sm hover:bg-[#071936] hover:text-white transition-all">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-[#071936] to-[#0e3169]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/search"
              className="inline-flex items-center justify-center gap-2 bg-white text-[#071936] px-8 py-4 rounded-full hover:bg-[#FFE9EE] transition-all font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105"
            >
            ...
            <Link
              href="/submission"
              className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 rounded-full hover:bg-white hover:text-[#071936] transition-all font-bold text-lg"
            >
